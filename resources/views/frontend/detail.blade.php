        ...
        <div class="row">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <ul class="list-info">
                    ...
                    <li class="row">
                        <p class="name col-xs-4"> {{ __('trans.Date create') }} : {{ $manga->created_at->diffForHumans() }}</p>
                    </li>
                    <li class="row">
                        <div>{{ __('trans.Ranking') }}: <rating v-bind:manga_id="{{ $manga->id }}" v-bind:manga_rate="{{ $manga->total_rate ? $manga->rate / $manga->total_rate : 0 }}"></rating></div>
                    </li><br>
                    <li class="row">
                        <br>
                        <div>
